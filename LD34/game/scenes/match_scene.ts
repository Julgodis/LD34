...
var repeats: Repeat[] = [];
function repate_function(data: any, func: RCallback, times: number, interval: number) {
    var rep = new Repeat();
    rep.data = data;
    rep.func = func;
    rep.times = times;
...
class ComboText {
    ...
    constructor(n: string, position: vec2, size: vec2, time: number) {
...
class MatchScene extends Scene {
    ...
    combo_sprites: [Sprite[], number][][];
    combo_text_sprites: TextSprite[];
    combo_cd_sprites: Sprite[];

    ground_particle: ParticleEmitter;
    opponents_dead: number;
    ...
    lose_rate: ButtonSprite;
    lose_title: TextSprite;
    lose_text: TextSprite;
    ...
    tut_dash: boolean = false;
    tut_jump: boolean = false;
    tut_bpunch: boolean = false;
    tut_cpunch: boolean = false;
    tut_jpunch: boolean = false;

    tut_text: TextSprite[];
    tut_text_dash: TextSprite;
    tut_text_jump: TextSprite;
    ...
    setup() {
        ...
        for (var index in combos) {
            ...
            for (var ai in combos[index]) {
                ...
                else this.combo_sprites[index].push([[], 0]);
    ...
    spawn_bot<T extends Bot>(name: string, tex: string, b: { new (position: vec2, size: vec2): T; }) {
        var sprite = new Sprite(0, 0, 1.0, 44, 80);
        sprite.color = new vec4([1.0, 1.0, 1.0, 1.0]);
    ...
    setup_match() {
        this.spawn_player(<number>this.match_id);
        ...
        if (this.match_id == MatchID.Tutorial) {     
            ...
            var y = y_start;
            var y_size = 40;
            var tutorial_text1 = new TextSprite("Welcome!", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text2 = new TextSprite("This is a fighting game with", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text3 = new TextSprite("only two input button (A and B)", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            y += 25;

            var tutorial_text4 = new TextSprite("A = Will turn the character around", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text5 = new TextSprite("B = Will move the character forward", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            y += 25;

            var tutorial_text6 = new TextSprite("Because you only have two button you ", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text7 = new TextSprite("will need to combine them togather", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text8 = new TextSprite("to make COMBOS (Attacks etc.)", 10, 10 + y, 100, 400, y_size, { center: false }); y += 25;

            y = y_start;
            var tutorial_text9 = new TextSprite("There is 5 combos (currently) in", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text10 = new TextSprite("the game. ", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            y += 25;

            var tutorial_text11 = new TextSprite("JUMP         =: A A", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text12 = new TextSprite("DASH         =: B B B", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text13 = new TextSprite("FIST STRIKE  =: B A", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text14 = new TextSprite("ENERGY PUSH  =: (B A) (B A)", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            var tutorial_text15 = new TextSprite("CANNONBALL   =: (A A) (A A) A", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            y += 25;

            var tutorial_text16 = new TextSprite("By 'A' I mean: press and release A", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            y += 25;

            var tutorial_text18 = new TextSprite("Complete every combo to continue.", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            this.tut_text_jump = new TextSprite("JUMP         [WAITING]", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            this.tut_text_dash  = new TextSprite("DASH         [WAITING]", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            this.tut_text_bpunch  = new TextSprite("FIST STRIKE  [WAITING]", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            this.tut_text_cpunch  = new TextSprite("ENERGY PUSH  [WAITING]", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
            this.tut_text_jpunch  = new TextSprite("CANNONBALL   [WAITING]", 10 + 450, 10 + y, 100, 400, y_size, { center: false }); y += 25;
    ...
    update(time: number, delta: number) {
            ...
            this.opponents.length > 0 )
        {
            ...
            setTimeout(() => {
                ...
                this.win_next_match.textures = [data.textures["button"].texture];
            ...
            this.player.hp.current_hp <= 0)
        {
           ...
           /* setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                this.lose_re_match = new ButtonSprite("Re-fight", 450 - 100, 350, 1001, 200, 50);
                this.lose_re_match.textures = [data.textures["button"].texture];
                this.lose_re_match.color = new vec4([0, 0, 1, 1]);

                context.passes[0].addSprite(this.lose_title);
                context.passes[0].addSprite(this.lose_re_match);
                context.passes[0].addSprite(this.lose_re_match.text);
                context.passes[0].addSprite(this.lose_rate);
                context.passes[0].addSprite(this.lose_rate.text);
            }, 8500);
    ...
    resolve_combo_actions(action: ActionType): ActionType[] {
    ...
    update_player(time: number, delta: number) {
            ...
            if (action != ActionType.None) {
                if (action == ActionType.BeginWalk)
                    ...
                    repate_function(data, (i, data) => {
                        this.player.attack_particles.lifetime = 0.5;
                        this.player.attack_particles.random_velocity = new vec2([0, 0]);
                        this.player.attack_particles.velocity = this.player.velocity.copy().mul(-1);
                        this.player.attack_particles.velocity.add(new vec2([0.2 * this.player.moveDirection, 0]));
                        this.player.attack_particles.position = this.player.position.copy().add(this.player.size.copy().mul(0.5 * ppm));
                        this.player.attack_particles.relative_random_position = this.player.size.copy().mul(0.5 * ppm).mul(new vec2([0, 1]));
                        this.player.attack_particles.spawn_max = 2;
                    ...
                    repate_function(data, (i, data) => {
                        this.player.attack_particles.lifetime = 0.5;
                        this.player.attack_particles.random_velocity = new vec2([0, 0]);
                        this.player.attack_particles.velocity = new vec2([0, 1]);
                        this.player.attack_particles.velocity.add(new vec2([(Math.random() - 0.5) * 0.5, 0.2 * this.player.moveDirection]));
                        this.player.attack_particles.position = this.player.position.copy().add(this.player.size.copy().mul(0.5 * ppm));
                        this.player.attack_particles.relative_random_position = this.player.size.copy().mul(0.5 * ppm).mul(new vec2([0.1, 1]));
                        this.player.attack_particles.spawn_max = 1;
                        this.player.attack_particles.spawn(time, delta);
                    ...
                    repate_function(data, (i, data) => {
                        this.player.attack_particles.lifetime = 0.5;
                        this.player.attack_particles.random_velocity = new vec2([0, 0]);
                        this.player.attack_particles.velocity = new vec2([this.player.moveDirection, 0]);
                        this.player.attack_particles.position = this.player.position.copy().add(this.player.size.copy().mul(0.5 * ppm));
                        this.player.attack_particles.relative_random_position = this.player.size.copy().mul(0.5 * ppm).mul(new vec2([1, 1]));
                        this.player.attack_particles.spawn_max = 2;
                        this.player.attack_particles.spawn(time, delta);
                    ...
                    for (var id in this.objects) {
                        ...
                        if (dist <= (this.player.size.x * 5) * ppm) {
                            ...
                            if (obj instanceof Bot) {
                                pe = (<Bot>obj).blood_system;
                                (<Bot>obj).attacked(this.player.cpunch_damage());
        ...
        if (this.player.onGround && this.player.jump_punch) {
            ...
            repate_function(pdata, (i, data) => {
                this.player.attack_particles.lifetime = 0.5;
                this.player.attack_particles.random_velocity = new vec2([0, 0]);
                this.player.attack_particles.velocity = <vec2>data[0];
                this.player.attack_particles.velocity.add(new vec2([0.2 * (Math.random() - 0.5), -(Math.random() - 0.5) * 1]));
                this.player.attack_particles.position = <vec2>data[1];
                this.player.attack_particles.relative_random_position = <vec2>data[2];
                this.player.attack_particles.spawn_max = 8;
                this.player.attack_particles.spawn(time, delta);
    ...
    update_opponent(time: number, delta: number, id: any, bot: Bot) {
    ...
    update_world(time: number, delta: number) {
       ...
       // var screen = new vec2([900, 600]);
        ...
        this.combo_text = this.combo_text.filter((value: ComboText, index: number, array: ComboText[]) => !value.dead);
    ...
    setup_ground_particles() {
        ...
        this.ground_particle.on_ground = ((particle: Particle) => { particle.scale_velocity = 0; });
